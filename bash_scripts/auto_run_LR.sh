...
log_file=/media/miri-o/Documents/logs/auto_run_${file}_LR.txt
score_file=/media/miri-o/Documents/logs/scores_${file}_LR.txt
...
do
	...
	do
		...
		echo "Classifying" 
		python classify.py $classify_file --labels_col_name 'labels' -M "LR" >>  $log_file
		line=$(tail -n 1 $log_file)
		score=${line##*: }
		echo ${Input_file##*/*/},${model_file##*/*/},${dim_method},${dims},${clust_method},${clusters},${TH},LR,${score} >> $score_file
