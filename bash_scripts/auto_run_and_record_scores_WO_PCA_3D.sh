...
model_file=/media/miri-o/Documents/trained_models_NEW/CDR3_from_Celiac_trimmied_3_4.model.model
log_file=/media/miri-o/Documents/logs/auto_run_HCV_data_only_CI_SC_10K_per_subject_191219_3D.txt
score_file=/media/miri-o/Documents/logs/scores_data_only_CI_SC_10K_per_subject_191219_3D.txt

vector_file_path=/media/miri-o/Documents/vectors/HCV_data_only_CI_SC_10K_per_subject_CDR3_from_Celiac_trimmied_3_4_VECTORS_tSNE_3D.csv

data_file=/media/miri-o/Documents/filtered_data_sets/HCV_data_only_CI_SC_10K_per_subject_CDR3_from_Celiac_trimmied_3_4_FILTERED_DATA.csv
