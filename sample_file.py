...
def main():
    ...
    parser.add_argument('--exclude_duplicates', help='do not sample the same cdr3_aa twice for the same subject, '
                                                     'default is True', default=True, type=str2bool)
    ...
    by_subject = input_data_file.groupby([id_column])
    sub_num = 0
    positive_subjects = 0
