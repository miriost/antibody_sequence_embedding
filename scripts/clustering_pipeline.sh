	...
	for knn_itr in ${knn}; do
      ...
      for min_significant_itr in ${min_significant}; do
        ...
        for max_distance_percentil_itr in ${max_distance_percentil}; do
          ...
          # build feature list
          echo "nice -19 python -u ~/antibody_sequence_embedding/build_knn_cluster_proximity_feature_list.py ${fold_dir}/${data_file} ${fold_dir}/${vectors_file} ${knn_dir}/${knn_itr}knn_distances.npy
          ${knn_dir}/${knn_itr}knn_neighbors.npy ${max_distance_percentil_dir}"
          nice -19 python -u ~/antibody_sequence_embedding/build_knn_cluster_proximity_feature_list.py ${fold_dir}/${data_file} ${fold_dir}/${vectors_file} ${knn_dir}/${knn_itr}knn_distances.npy 
          ${knn_dir}/${knn_itr}knn_neighbors.npy ${max_distance_percentil_dir} 100knn_${p}p_feature_list --min_subjects ${min_subjects_itr} --min_significant ${min_significant_itr}
