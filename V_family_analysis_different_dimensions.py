...
data = pd.read_csv('/media/miri-o/Documents/filtered_data_sets/FLU_data_012119_celiac_model_Jan19_2019_FILTERED_DATA2.csv', sep = ',')
...
for dim in dimensions:
    vectors = pd.read_csv('/media/miri-o/Documents/vectors/FLU_data_012119_'+str(dim)+'D_PCA.csv', sep = ',')
    print('--------------\n' + str(dim) + ' Dimensions ~~~\n')  
